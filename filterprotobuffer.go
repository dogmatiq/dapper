...
func ProtobufferFilter(
	...
	// prototext.MarshalOptions only allows tabs and spaces to be used for indentation.
	// Fall back to spaces if the configured one is not valid, so we can still render something.
	protoIndent := "    "
